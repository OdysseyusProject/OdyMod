...
import fr.odysseyus.mod.procedures.StyoritetntExplosionProcedure;
...
public class StyoritetntBlock extends OdysseyusModElements.ModElement {
	@ObjectHolder("odysseyus:styoritetnt")
	public static final Block block = null;

	public StyoritetntBlock(OdysseyusModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				StyoritetntExplosionProcedure.executeProcedure(Stream
