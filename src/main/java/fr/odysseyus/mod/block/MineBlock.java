...
import fr.odysseyus.mod.procedures.MineExplosionProcedure;
...
public class MineBlock extends OdysseyusModElements.ModElement {
	@ObjectHolder("odysseyus:mine")
	public static final Block block = null;

	public MineBlock(OdysseyusModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			MineExplosionProcedure.executeProcedure(Stream
