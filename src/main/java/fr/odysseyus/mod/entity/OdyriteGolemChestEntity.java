...
package fr.odysseyus.mod.entity;
...
import fr.odysseyus.mod.gui.GolemGui;
import fr.odysseyus.mod.entity.renderer.OdyriteGolemChestRenderer;
...
public class OdyriteGolemChestEntity extends OdysseyusModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.4f, 2.7f)).build("odyrite_golem_chest").setRegistryName("odyrite_golem_chest");

	public OdyriteGolemChestEntity(OdysseyusModElements instance) {
		super(instance, 45);
		FMLJavaModLoadingContext.get().getModEventBus().register(new OdyriteGolemChestRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16763905, new Item.Properties().group(OdysseyusItemGroup.tab))
				.setRegistryName("odyrite_golem_chest_spawn_egg"));
	}
	...
	public static class CustomEntity extends IronGolemEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Odyrite Golem [Coffre]"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(OdyriteblockBlock.block));
		}
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Odyrite Golem Coffre");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GolemGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
